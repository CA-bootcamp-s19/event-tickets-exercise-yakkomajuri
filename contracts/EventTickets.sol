...
contract EventTickets {
    ...
    */
    ...
    event LogEndSale(address owner, uint valueReceived);
    ...
    */
    constructor(string memory description, string memory _websiteUrl, uint _nTicketsForSale) public {
        owner = msg.sender;
    ...
    */
    function getBuyerTicketCount(address _buyer) external view returns (uint) {
